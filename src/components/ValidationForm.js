...
function ValidationForm({ navigation, initialValues, screenKey }) {
    ...
    const onSubmit = data => {
        ...
        if (user.userImgToPush) {
            imageToSend = 'data:image/jpeg;base64,' + user.userImgToPush;
        }
        else {
    ...
    return (
        <View>
            <Text styles={styles.fieldName}>First Name: </Text>
            <Controller
                control={control}
            ...
            <Text styles={styles.fieldName}>Last Name: </Text>
            <Controller
                control={control}
                render={({ onChange, onBlur, value }) => (
                    <TextInput
            ...
            <Text styles={styles.fieldName}>Age: </Text>
            <Controller
                control={control}
                render={({ onChange, onBlur, value }) => (
            ...
            <Text styles={styles.fieldName}>E-mail: </Text>
            <Controller
                control={control}
                render={({ onChange, onBlur, value }) => (
                    <TextInput
            ...
            <Text styles={styles.fieldName}>Login: </Text>
            <Controller
                control={control}
                render={({ onChange, onBlur, value }) => (
                    <TextInput
